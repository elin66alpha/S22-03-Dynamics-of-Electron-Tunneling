...
class NormalRun(Run):
    ...
    def _csv_filename(self) -> str:
        ...
        name = f'{self.position}_{date}_{activity}_{vmin}_{vmax}_{self.rr}_{self.icc}.csv'  #set the file name for the csv containing the processed version of the raw keithley input data
